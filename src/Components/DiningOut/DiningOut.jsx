...
import { ExploreSection } from '../Delivery/ExploreSection/ExploreSection.jsx';
import { Filter } from '../Filter/Filter';
import './DiningOut.css'
const DiningOutList=dining
console.log(DiningOutList)
...
export const DiningOut = () => {
  return (
    ...
    <ExploreSection list={DiningOutList} collectionName='Dine-Out Restaurants in Delhi'/>
    </div>
  )
}
